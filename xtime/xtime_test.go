...
func TestTimeSpan(t *testing.T) {
	...
	xtesting.EqualFloat(t, ts.TotalSeconds(), 451944.123456789, 1e-3)
	xtesting.EqualFloat(t, ts.TotalMinutes(), 7532.402057613, 1e-3)
	xtesting.EqualFloat(t, ts.TotalHours(), 125.540034293, 1e-3)
	xtesting.EqualFloat(t, ts.TotalDays(), 5.230834762, 1e-3)
